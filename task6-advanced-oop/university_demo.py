...
def demo():
    ...
    instructor1 = Instructor("Damour Dev", "LCT22446", "INFORMATION TECHNOLOGY")
    ...
    print(f"Course information: \n Code: {course2.course_code}, Name: {course2.course_name}, Credits: {course2.credits}, Instructor: {course2.instructor.name}")  
     # Create students
    student1 = Student("Emmy", "REG22456")
    student2 = Student("Olivier", "REG22457")
    ...
    ta1 = TeachingAssistant("Mr Damour", "REG22111", "LCT22111", "PYTHON")
