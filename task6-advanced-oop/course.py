...
class Course:
    ...
    Attributes:
        ...
        instructor (Person): instructor for the course".
        students (list[Person]): list of students enrolled in the course.
        """
...
Lecture = Instructor("Damour Dev", "REG22446", "Python") 
course = Course("PY101", "Python Programming", 3, Lecture) 
print(course) 
