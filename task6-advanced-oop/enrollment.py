...
s1 = Student("Damour Dev","REG22446")
s2 = Student("Emmy","REG22447")
lecture = Instructor("Pelino", 13,"D001")

course1 = Course("PY001", "Python Programming", 3, lecture)
course2 = Course("WEB001", "Web Development", 4, lecture)
